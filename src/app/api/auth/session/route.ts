  ...
  for (const friend of friends) {
    try {
      ...
      if (isEnsUser) {
        ...
        await query(
          `INSERT INTO users (user_id, name, profile_picture_url, identity_type, wallet_address, ens_domain, settings, updated_at)
        ...
        await query(
          `INSERT INTO users (user_id, name, profile_picture_url, identity_type, up_address, settings, updated_at)
        ...
        await query(
          `INSERT INTO users (user_id, name, profile_picture_url, identity_type, settings, updated_at)
